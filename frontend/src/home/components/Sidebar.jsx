...
return(
  <div className='h-full w-auto px-1'>
   <div className='flex justify-between gap-2'>
    ...
    value={searchInput}
     ...
     type='text'
     className='px-4 w-auto bg-transparent outline-none rounded-full  text-black placeholder-gray-400'
  ...
  />
   ...
   <img
    ...
    alt='me'
    className='self-center h-12 w-12 rounded-full object-cover border border-orange-500 '/>
 </div>
...
<div className='divider px-3'></div>
  {searchUser?.length > 0 ?(
   ...
   <div key={user._id}>
    <div onClick={() => handelUserClick(user)}
  ...
  <div className='flex flex-col flex-1'>
    <p className='font-bold text-red-500'>{user.username}</p>
    </div>
    </div>
